...
import 'package:just_audio_media_kit_example/common.dart';
...
class MyAppState extends State<MyApp> with WidgetsBindingObserver {
  ...
  final _playlist = ConcatenatingAudioSource(children: [
    // /tmp/audio.mp3 is just a download from https://s3.amazonaws.com/scifri-episodes/scifri20181123-episode.mp3
    // to test local playback
    AudioSource.file(
      '/tmp/audio.mp3',
      tag: AudioMetadata(
                          ...
                          Dismissible(
                            ...
                            child: Material(
                              ...
                              child: ListTile(
                                ...
                                onTap: () async {
                                  // i know that we're not supposed to do this,
                                  // but in my application i need to update the queue, therefore
                                  // the audiosource, so this is needed in my case
